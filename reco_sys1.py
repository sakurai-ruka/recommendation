...
messages.append({"role": "system", "content": system_msg})
goods1 = "商品" + ":" + "野中精肉店" + "の" + "佐賀牛ワサビで食べる牛肉もも肉ステーキ100グラム" +"価格:"+ price +"URL:"+url+"評価："+ rev +"\n"
goods2 = "商品" + ":" + shop + "の" + name +"価格:"+ price +"URL:"+url+"評価："+ rev +"\n"
goods3 = "商品" + ":" + shop + "の" + name +"価格:"+ price +"URL:"+url+"評価："+ rev +"\n"
messages.append({"role": "system", "content": goods1})
#logに記録されていない会話を追加
